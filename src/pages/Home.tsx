...
const services = [
  {
    n: "01",
    title: "Carpenter",
    description: "Custom carpentry and expert woodwork for residential and commercial spaces.",
    image: img.workshop3,
  },
  {
    n: "02",
    title: "Custom Furniture",
    description: "Bespoke furniture designed and crafted according to the client's requirements.",
    image: img.bedroom2,
  },
  {
    n: "03",
    title: "Interior Design",
    description: "Complete interior design solutions for homes, offices and commercial spaces.",
    image: img.livingRoom5,
  },
  {
    n: "04",
    title: "Wood Polishing",
    description: "Professional wood polishing and finishing to restore, protect and enhance furniture.",
    image: img.woodTexture2,
  },
  {
    n: "05",
    title: "Painting",
    description: "Professional interior and exterior painting with smooth finishes, quality materials and attention to detail.",
    image: img.painting1,
  },
];
...
const whatWeDoServices = [
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/8082233/pexels-photo-8082233.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=1200&w=1600",
    to: "/office-interiors",
  },
];
...
const seoAreaCards = [
  ...
  { title: "Furniture Near Lado Sarai and Aya Nagar", text: "Customers in Lado Sarai and Aya Nagar can explore custom furniture, wardrobes and complete interior solutions designed for their homes and workspaces." },
  { title: "Furniture Near Ghitorni and Sainik Farm", text: "We serve homeowners in Ghitorni and Sainik Farm with made-to-measure furniture, practical storage and refined interior design solutions." },
  { title: "Furniture Near Neb Sarai and Saidulajab", text: "Residents of Neb Sarai and Saidulajab can find furniture tailored to their space, lifestyle and everyday requirements at Kohinoor Furniture House." },
  { title: "Furniture Near Maidan Garhi, Rajpur Khurd and Satbari", text: "Kohinoor Furniture House supports customers in Maidan Garhi, Rajpur Khurd and Satbari with durable, stylish furniture and complete home solutions." },
];
...
export default function Home() {
  return (
    <>
      ...
      {/* SERVICES */}
      <section className="border-y border-champagne/40 bg-ivory py-24 md:py-32">
        <div className="container-xl">
          <div className="mb-12 max-w-3xl">
            <p className="label">OUR SERVICES</p>
            <h2 className="mt-5 font-serif text-4xl leading-[1.1] text-forest md:text-5xl">
              Crafted solutions for living beautifully.
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-6">
            {services.map((service, index) => (
              <article
                key={service.title}
                className={`group overflow-hidden border border-gold/35 bg-ivory shadow-[0_18px_40px_rgba(11,47,38,0.06)] transition-all duration-500 hover:-translate-y-1 hover:border-gold/80 hover:shadow-[0_26px_44px_rgba(11,47,38,0.1)] lg:col-span-2 ${index === 3 ? "lg:col-start-2" : ""} ${index === 4 ? "lg:col-start-4" : ""}`}
              >
                <div className="relative h-[300px] overflow-hidden md:h-[330px]">
                  <img
                    src={service.image}
                    alt={service.title}
                  ...
                  <span className="absolute left-5 top-5 inline-flex h-10 w-10 items-center justify-center border border-ivory/80 bg-[rgba(15,20,18,0.25)] text-[10px] font-medium tracking-[0.18em] text-ivory backdrop-blur-[2px]">
                    {service.n}
                  </span>
                </div>

                <div className="space-y-4 p-7 md:p-8">
                  <h3 className="font-serif text-3xl leading-none text-forest">{service.title}</h3>
      ...
      <section className="bg-emerald py-24 text-ivory md:py-32">
        <div className="container-xl">
          ...
          <div className="mt-16 grid grid-cols-1 gap-px overflow-hidden bg-ivory/10 sm:grid-cols-2 lg:grid-cols-3">
            {whatWeDoServices.map((item, index) => (
              <Reveal key={item.title} delay={index * 0.06}>
                <Link to={item.to} className="group relative block h-[420px] overflow-hidden bg-emerald">
                  <img
                    src={item.image}
                    alt={item.title}
                  ...
                  <div className="service-card-copy absolute bottom-4 left-4 z-10 inline-flex max-w-[calc(100%-32px)] flex-col items-start border border-ivory/50 bg-[rgba(246,242,233,0.88)] px-2.5 py-1.5 text-left shadow-[0_4px_14px_rgba(26,22,18,0.04)] backdrop-blur-[1px] md:bottom-5 md:left-5 md:px-3 md:py-1.5">
                    <span className="text-[8.5px] font-medium uppercase tracking-[0.18em] text-forest/90 md:text-[9px]">{item.n}</span>
                    <h3 className="mt-0.5 font-serif text-[15px] leading-[1.15] text-forest md:text-[17px]">{item.title}</h3>
                  </div>
                </Link>
              </Reveal>
            ))}
