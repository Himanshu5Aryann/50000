...
import CustomWardrobes from "./pages/CustomWardrobes";
        ...
        <BrowserRouter>
          <Routes>
            <Route element={<Layout />}>
              ...
              <Route path="office-interiors" element={<OfficeInteriors />} />
              <Route path="modular-kitchens" element={<ModularKitchens />} />
              <Route path="custom-wardrobes" element={<CustomWardrobes />} />
